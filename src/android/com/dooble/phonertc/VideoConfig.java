...
public class VideoConfig {
	...
	public int getDeviceValue(int v) {
		return (int)(_devicePixelRatio * v);
	}

	public int getWidthPercentage(int x) {
		return (int)(x * 100.0 / _container.getWidth());
	}

	public int getHeightPercentage(int y) {
		return (int)(y * 100.0 / _container.getHeight());		
	}
	...
	public static VideoConfig fromJSON(JSONObject json) throws JSONException {
		...
		config.setDevicePixelRatio(json.getDouble("devicePixelRatio"));
	...
	public void setDevicePixelRatio(double _devicePixelRatio) {
